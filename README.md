...
Version 1.3.7 includes the optional Qualcomm QNN/HTP backend alongside the existing Vulkan
...
Version 1.3.7 also includes on-device spatial images powered by Depth Anything V3. The first run
