...
Use `export_w2xex_onnx.py` to reconstruct the W2xEX Photo Small ONNX graph from its upstream
NCNN parameter and weight files. The exporter converts the model's BGR channel order to RGB.
